...
RSpec.describe RequestsController, :type => :controller do
  ...
  describe 'POST #create' do
    ...
    it 'responds with an empty template' do
      post :create, params: {api_key: @website.api_key, requests: reqs.to_json}
      expect(response).to render_template(nil)
    end

    it 'responds with unauthorized in case of a wrong API key' do
      post :create, params: {api_key: 'nope', requests: reqs.to_json}
    ...
    context 'invalid data' do
      ...
      it 'responds with a bad_request code in case of an invalid json' do
        post :create, params: {api_key: @website.api_key, requests: 'totally not valid here'}
      end
