...
RSpec.describe WebsitesController, :type => :controller do
  ...
  describe 'POST #create' do
    it 'creates a new website and redirects' do
      expect {
        post :create, website: FactoryGirl.attributes_for(:website, name: 'A new one')
    ...
    it 'uses strong params' do
      ...
      post :create, website: FactoryGirl.attributes_for(:website)
    end

    it 'renders new when data is invalid' do
      expect {
        post :create, website: FactoryGirl.attributes_for(:website, name: '')
  ...
  describe 'POST #update' do
    it 'updates website and renders edit' do
      post :update, id: @website.id, website: {name: 'Updated name!'}
      @website.reload
    ...
    it 'uses strong params' do
      ...
      post :update, id: @website.id, website: {name: 'New name!'}
    end

    it 'renders edit when data is invalid' do
      post :update, id: @website.id, website: {name: ''}
      @website.reload
  ...
  it 'allows only name and url through website_params' do
    expect_any_instance_of(Website).to receive(:update).with({
      'name' => 'New name!',
      'url' => 'www.new.url.com'
    }).and_call_original
    post :update, id: @website.id, website: {name: 'New name!', url: 'www.new.url.com', api_key: '12345'}
  end
  ...
  describe 'GET #regenerate_api_key' do
    it 'generates a new API key and saves it' do
      ...
      get :regenerate_api_key, id: @website.id
  ...
  describe 'GET #confirm_delete' do
    it 'gets confirm_delete' do
      get :confirm_delete, id: @website.id
      expect(assigns(:website)).to eq(@website)
    end
  end
